...
public:
  ...
  bool erase(const conjunto::value_type & e);
	...
	*/
	...
	@post no modifica el conjunto.
	*/
	conjunto::const_iterator lower_bound (const string & chr, const unsigned int & pos) ;
	conjunto::const_iterator lower_bound (const conjunto::value_type & e) ;
	...
	@post no modifica el conjunto.
	*/
	conjunto::const_iterator upper_bound (const string & chr, const unsigned int & pos) ;
	conjunto::const_iterator upper_bound (const conjunto::value_type & e) ;
  ...
  */
	...
	/**
	@brief obtiene las mutaciones existentes
	@post no modifica el conjunto.
	*/
