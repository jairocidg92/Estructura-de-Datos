...
//  for (int tama = 10; tama < 50000 ; tama+= 100){
//
...
//  for (int tama = 0; tama < 50000 ; tama+= 100){
//
//  start =  high_resolution_clock::now();;
//
...
//  for (int tama = 0; tama < 1000000 ; tama+= 1000){
//
//  start =  high_resolution_clock::now();;
//
...
//  }
 ...
 for (int tama = 0; tama < 100000 ; tama+= 100){
